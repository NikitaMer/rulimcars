            ...
            <form method="post" action="/rent/thankyou.php" class="rentpost">
                ...
                <label>
                       <select class="select" name="YEAR" id="select_city">
                        ...
                        <?foreach ($arResult['CITY'] as $key=>$arElement) {?>
                ...
                <label>
                       <select class="select must" name="AUTO" id="select_car">
                        ...
                        <?foreach ($arResult['CAR'] as $key=>$arElement) {?>
                            <option <?if ($key == $arResult['RES_CAR_ID']): ?>selected="selected"<? endif;?> data_path="<?=CFile::GetPath($arElement['PREVIEW_PICTURE'])?>" 
                                value="<?=$arElement["ID"]?>">
                                <?=$arElement["NAME"]?> <?=$arElement['PROPERTIES']['YEAR_CAR']?>
                            </option>
                        <?}?>
                       </select>
                </label>
                ...
                <div class="with_driver">
                    ...
                    <label><input autocomplete="on" type="text" class="address_delivery_with_driver" name="ADDRESS_DELIVERY" placeholder="<?=GetMessage("ADDRESS_DELIVERY")?>" value="" disabled="disabled"></label>
                    <label><input autocomplete="on" type="text" class="address_return_with_driver" name="ADDRESS_RETURN" placeholder="<?=GetMessage("ADDRESS_RETURN")?>" value="" disabled="disabled"></label>
                </div>
                <div class="without_driver">
                    ...
                    <label style="display: none;"><input autocomplete="on" type="text" class="address_delivery_without_driver" name="ADDRESS_DELIVERY" placeholder="<?=GetMessage("ADDRESS_DELIVERY")?>" value="" disabled="disabled"></label>
                    ...
                    <label style="display: none;"><input autocomplete="on" type="text" class="address_return_without_driver" name="ADDRESS_RETURN" placeholder="<?=GetMessage("ADDRESS_RETURN")?>" value="" disabled="disabled"></label>
                </div>        
                
                <label><textarea class="textarea" id="comment" placeholder="<?=GetMessage("PLACE_COMMENT")?>" name="TEXT"></textarea></label>
                <label class="invisible"><input autocomplete="off" type="text" id="result" class="input invisible" name="RESULT" placeholder="<?=GetMessage("PLACE_RESULT")?>"/></label>                            
                <label class="invisible"><input autocomplete="off" type="text" id="days" class="input invisible" name="DAYS" placeholder="<?=GetMessage("PLACE_DAY")?>"/></label>                            
                <label class="invisible"><input autocomplete="off" type="text" id="orderid" class="input invisible" name="ORDERID" placeholder="<?=GetMessage("PLACE_ORDER")?>"/></label>                            
            </form>
        </div>
